...
class th extends Langs {
	...
	public function basics($text=null) {
		...
		$data['items per pages'] = 'จำนวนต่อหน้า';
		$data['status'] = 'สถานะ';
		$data['forum'] = 'ประเภทข่าว';
		$data['create'] = 'สร้าง';
		$data['search'] = 'ค้นหา';
		$data['edit'] = 'แก้ไข';
		$data['delete'] = 'ลบ';
		...
		$data['blog forum'] = 'กลุ่มข่าว';
		$data['blog category'] = 'ประเภทข่าว';
	...
	public function menu($text=null) {
		...
		// $data['category'] = 'ข่าวสารเพื่อชาวไร่';
		$data['about'] = 'เรามิตรผลโมเดิร์นฟาร์ม';
		$data['service'] = 'บริการ';
		$data['contact'] = 'ติดต่อ';
