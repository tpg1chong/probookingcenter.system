...
class Bootstrap {
    ...
    private $_itemsPath = array('media', 'booking', 'tour', 'office');
    ...
    private function _getUrl()
    {
        ...
        $_GET['url'] = rawurldecode($url);
        
        list($host, $get) = explode('?', $url);
        ...
        foreach (explode('&', $get) as $key => $value) {
            $d = explode('=', $value);
            $_GET[$d[0]] = $d[1];
        }
    }
