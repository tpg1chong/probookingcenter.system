...
class Teams_Model extends Model{
    ...
    private $_objName = "teams";
    private $_table = "teams";
    private $_field = "*";
    private $_cutNamefield = "team_";
    ...
    public function is_name($name){
    	return $this->db->count($this->_objName, "{$this->_cutNamefield}name={$name}");
    }
    ...
    public function convert($data, $options=array()){
    	...
    	$data["total_user"] = $this->db->count("user", "user_team_id={$data["id"]}");
    	$data["permit"]["del"] = true;
    	if( !empty($data["total_user"]) ){
