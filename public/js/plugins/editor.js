...
(function( $, window, document, undefined ) {
	...
	var Editor = {
		...
		Theme: function(editor, target){
			...
			var toolbar = ['bold italic | justifyleft justifycenter justifyright | link | numlist bullist | blockquote' ];

			// {title: "Header 1",format: "h1"}, {title: "Header 2",format: "h2"}, {title: "Header 3",format: "h3"}
