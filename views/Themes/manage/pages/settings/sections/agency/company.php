...
$url = URL.'agency_company/';

?><div data-load="<?=$this->pageURL?>settings/agency/company" class="SettingCol offline">

<div class="SettingCol-header"><div class="SettingCol-contentInner">
	<div class="clearfix">
		<ul class="clearfix lfloat SettingCol-headerActions">

			<li><h2><i class="icon-building mrs"></i><span>บริษัทเอเจนซี่</span></h2></li>
...
<div class="SettingCol-main">
	<div class="SettingCol-tableHeader"><div class="SettingCol-contentInner">
		<table class="settings-table admin"><thead><tr>
			<th class="status" data-col="0"></th>
			<th class="name" data-col="1">Company Name</th>
			<!-- <th class="email" data-col="2">Email</th> -->
			<th class="status_th" data-col="3"></th>
