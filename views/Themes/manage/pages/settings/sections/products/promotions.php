...
?><div data-load="<?=$this->pageURL?>settings/products/promotions" class="SettingCol offline">

<div class="SettingCol-header"><div class="SettingCol-contentInner">
	<div class="clearfix">
		<ul class="clearfix lfloat SettingCol-headerActions">

			<li><h2><i class="icon-lightbulb-o mrs"></i><span>โปรโมชั่น</span></h2></li>
...
<div class="SettingCol-main">
	<div class="SettingCol-tableHeader"><div class="SettingCol-contentInner">
		<table class="settings-table admin"><thead><tr>
			<th class="status_th" data-col="0">สถานะ</th>
			<th class="name" data-col="1">หัวข้อ</th>
			<th class="event_date" data-col="2">ระยะเวลา</th>
			<th class="status" data-col="3">ส่วนลด(บาท)</th>
			<th class="actions" data-col="4">Action</th>
		</tr></thead></table>
	</div></div>
	...
	<div class="SettingCol-tableEmpty empty">
		...
		<div class="empty-text">
			<div class="empty-icon"><i class="icon-lightbulb-o"></i></div>
