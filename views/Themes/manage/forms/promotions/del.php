...
if ( !empty($this->item['permit']['del']) ) {
	...
	$arr['form'] = '<form class="js-submit-form" action="'.URL. 'promotions/del/"></form>';
	$arr['hiddenInput'][] = array('name'=>'id','value'=>$this->item['id']);
	$arr['body'] = "คุณต้องการลบโปรโมชั่น <span class=\"fwb\">\"{$this->item['name']}\"</span> หรือไม่?";
	...
	$arr['body'] = "คุณไม่สามารถลบโปรโมชั่น <span class=\"fwb\">\"{$this->item['name']}\"</span> ได้?";	
